...
**Popup -> textarea + Read Text.** Type or paste any text into the textarea and click **Read Text**. The character count is gray under 2,000 characters, yellow at 2,000-5,000, red over 5,000 (some speech engines may cut off very long inputs). Hover the count for the explanation. The trash icon next to the textarea clears it. The question-mark icon opens this getting-started guide.
